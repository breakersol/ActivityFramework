...
void TA_ActivityProxyTest::SetUp() { m_pTest = new MetaTest(); }
...
TEST_F(TA_ActivityProxyTest, MetaActivityTest) {
    decltype(auto) pActivity = new CoreAsync::TA_MetaActivity<decltype(META_STRING("sub")), MetaTest *&, int, int>(
        META_STRING("sub"), m_pTest, 9, 8);
