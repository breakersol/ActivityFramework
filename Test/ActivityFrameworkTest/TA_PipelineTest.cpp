...
{
    auto activity_1 = CoreAsync::ITA_ActivityCreator::create(&MetaTest::sub, m_pTest, 1,2);
    auto activity_2 = CoreAsync::ITA_ActivityCreator::create(&MetaTest::sub, m_pTest, 2,2);
    auto activity_3 = CoreAsync::ITA_ActivityCreator::create(&MetaTest::sub, m_pTest, 10,1);
...
{
    auto activity_1 = CoreAsync::ITA_ActivityCreator::create(&MetaTest::sub, m_pTest, 1,2);
    auto activity_2 = CoreAsync::ITA_ActivityCreator::create(&MetaTest::sub, m_pTest, 5,2);
    auto activity_3 = CoreAsync::ITA_ActivityCreator::create(&MetaTest::sub, m_pTest, 10,1);
