...
class TA_ActivityResultAwaitable {
  public:
    ...
    TA_ActivityResultAwaitable(Activity *pActivity, bool autoDelete) : m_pActivity(pActivity) {
        if (!m_pActivity) {
